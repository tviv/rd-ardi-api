...
const dailyRevenueFieldPrefix =
    ...
    MEMBER [Кол артикулов] as Measures.[Количество товара] - ([Товары].[Товары].&[109997] /*прочие*/, Measures.[Количество товара]) 
    MEMBER [Кол клиентов] as Measures.[Кол чеков] - ([Товары].[Товары].&[109997] /*прочие*/, Measures.[Кол чеков]) 
