...
const dailyRevenueFieldPrefix =
    ...
    MEMBER [Еком ТО] AS SUM({[Способы покупки].[Способ покупки].&[7],[Способы покупки].[Способ покупки].&[8]}, [Сумма])
	MEMBER [Еком Кол клиентов] AS SUM({[Способы покупки].[Способ покупки].&[7],[Способы покупки].[Способ покупки].&[8]}, [Measures].[Кол клиентов ])
	MEMBER [Еком Средний чек] AS SUM({[Способы покупки].[Способ покупки].&[7],[Способы покупки].[Способ покупки].&[8]}, [Средняя сумма])
    ...
    ,[Measures].[Средний чек],[Measures].[Кол артикулов],[Measures].[Кол артикулов на 1 клиента], [Measures].[Ср. ст-ть артикула], [Measures].[Остаток кол артикулов],[Measures].[Остаток сумма без НДС],[Measures].[Коэф оборачиваемости]
    ...
    ,[Еком ТО], [Еком Кол клиентов], [Еком Средний чек]
